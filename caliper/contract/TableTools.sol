...
contract TableTools {
    ...
    string constant PerChaseOrder_PrimaryKey = "index";
    ...
    string constant TransOrder_PrimaryKey = "index";
    string constant TransOrderField = "perchaseIndex,perchaseCompany,transCompany,clearanceLocation,entryLocation,clearanceTime,entryTime,situation";
